  ...
  <div>
    <div class="upload_image_box">
      <form enctype="multipart/form-data" ref="form">
        <i v-if="!disable_file_input" @click="removePreview($event)" :class="[src ? 'd-block' : 'd-none','remove']">
        ...
        <input :disabled="disable_file_input" @change="showPreview($event)" type="file"
