...
aside {
  ...
  min-height: 100px;
  box-shadow: 0 0 5px rgba(116, 131, 123, 0.91);
  border-radius: 4px;
  padding: 10px;
}
  ...
  > li {
    ...
    .sidebar_opener {
      ...
      &:hover {
        ...
        box-shadow: 0 0 4px rgba(89, 99, 94, 0.76);
      }
...
.sidebar_ul_level_2 {
  ...
  overflow: hidden;
  padding-top: 5px;
  border: 1px solid rgba(27, 30, 29, 0.3);
