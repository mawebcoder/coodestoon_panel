...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$store.state.pageTitle = 'لیست مقالات فعال';
        ...
        watch: {
            current(value) {
                this.$store.state.loading = true;
                ArticleService.paginateActiveArticles(value)
                    .then(res => {
                        let list = [];
        ...
        methods: {
            ...
            searchInTable() {
                ...
                this.$store.state.loading = true;
                ArticleService.searchInActiveArticles(this.search_value)
                    .then((res) => {
                        let list = [];
                        if (res.status === 204) {
                            this.rows = [];
            ...
            onCellClick(params) {
                ...
                switch (tagName) {
                    case ("BOX-ICON"):
                        ...
                        if (column_name === 'edit') {
                            this.$router.push({name: 'article-edit',params: {article: row_object.id},query:{from_actives:true}})
