...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$store.state.pageTitle = 'لیست دسته بندی های غیر فعال مقالات';
            ...
            onCellClick(params) {
                ...
                switch (tagName) {
                    case ("BOX-ICON"):
                        ...
                        if (column_name === 'edit') {
                            this.$router.push({name:'article-category-edit',params:{articleCategory:row_object.id},query:{from_de_actives:true}})
